...
// GetSupportedMimeTypes returns all supported MIME types for the application
func GetSupportedMimeTypes() map[string][]string {
	return map[string][]string{
		"csv": {
			"text/csv",
			"application/csv",
			"text/plain", // CSV files might be detected as plain text
		},
		"docx": {
